...
public class TourMatchListAdapter extends RecyclerView.Adapter<TourMatchListAdapter.MyViewHolder> {

    private List<TourDatum> tourDatumList;
    private Context context;

    public TourMatchListAdapter(Context context, List<TourDatum> tourDatumList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.tour_matchlist_row, parent, false);
...
//        }
        ...
        holder.basicinfo_ll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                SharedPreference.saveArrayList(context,tourDatumList,SharedprefKeys.CURRENT_TOUR_DATUM);
                SharedPreference.setSharedPreferenceInt(context,SharedprefKeys.CURRENT_TOUR_POSITION,position);


                Intent intent = new Intent(context,Activity_JoinTour.class);
